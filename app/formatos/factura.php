...
.borde-azul{
	border: #004b80 1px solid ;
}
.borde-iz{
	border-left: #004b80 1px solid;
}
.borde-der{
	border-right: #004b80 1px solid;
}
.borde-bot{
	border-bottom: #004b80 1px solid;
}
b{
	font-family: sfsemi;
}
		...
		<tr>
	    	<td width="180" height="150" valign="top">
		    	<table width="100%" border="0" cellpadding="0" cellspacing="0">
					<tr>
						<td width="180" height="150" align="center" valign="middle"><img src="../logoadmins_AZUL.png" width="150" /></td>
	        		</tr>
				</table>
			</td>
...
<? foreach ($xml->xpath('//cfdi:Comprobante//cfdi:Conceptos//cfdi:Concepto') as $Concepto){ ?>
    	<tr>
			...
			<td width="290" height="20"><?=utf8_decode($Concepto['descripcion'])?></td>
...
<table width="780" class="borde-azul" cellpadding="0" cellspacing="0">
  <tr>
    ...
    <td width="260" rowspan="2" valign="top"><table width="100%" style="border-left:#004b80 1px solid;" cellpadding="0" cellspacing="0">
      <tr>
